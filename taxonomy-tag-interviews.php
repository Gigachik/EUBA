    ...
    <div class="container">
        <div class="interviews_inner" id="post-container">
            <?php   
                ...
                $custom_post_types = array('interviews', 'meinungen', 'reportagen', 'reports', 'veranstaltungen');

                $jsonData = json_encode($custom_post_types);
        ...
        <?php  
            if($post_count > 5){
        ?>
            <button class="more" id="load-more-posts" data-type='<?php echo $jsonData; ?>' data-exclude="all-cpt" data-slug="<?php echo $queryObject->slug; ?>">WEITERE ARTIKEL anzeigen</button>
