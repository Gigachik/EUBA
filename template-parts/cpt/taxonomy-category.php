<?php
add_action( 'category', 'render_category', 10, 1);

function render_category($queryObject) { ?>     
<?php
    ...
    <section class="interviews">
        <div class="container">
            ...
            <?php  
                if($post_count > 5){
            ?>
                <button class="more" id="load-more-posts" data-type='<?php echo $cpt; ?>' data-exclude="category-cpt" data-slug="<?php echo $queryObject->slug; ?>">WEITERE ARTIKEL anzeigen</button>
